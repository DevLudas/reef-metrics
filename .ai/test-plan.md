...
- **Third-Party Infrastructure Testing:** We will not test the internal infrastructure of Supabase or OpenRouter. Our scope is limited to testing the _integration_ with these services.
