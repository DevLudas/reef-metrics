...
import type { AquariumDTO, AquariumListItemDTO, AquariumEntity, CreateAquariumCommand, MeasurementDTO } from "@/types";
 ...
 */
export function transformCreateAquariumCommand(command: CreateAquariumCommand): Record<string, unknown> {
  return {
    name: command.name,
 ...
 */
export function transformAquariumEntityToDTO(
 ...
 */
export function transformAquariumEntityToListItemDTO(
  entity: AquariumEntity & {
...
export function transformMeasurementResponse(data: Record<string, unknown>): MeasurementDTO {
  return {
    ...
    parameter: {
      name: (data.parameter as Record<string, unknown>)?.name as string,
      full_name: (data.parameter as Record<string, unknown>)?.full_name as string,
      unit: (data.parameter as Record<string, unknown>)?.unit as string,
    },
  };
}
