...
describe("MeasurementsService", () => {
  ...
  describe("getMeasurements", () => {
    ...
    it("should throw NOT_FOUND when aquarium does not exist", async () => {
      ...
      // Act & Assert
      await expect(service.getMeasurements(userId, aquariumId)).rejects.toThrow("NOT_FOUND");
    });
    ...
    it("should apply sorting with correct order", async () => {
      ...
      // Act
      await service.getMeasurements(userId, aquariumId, {}, {}, { sort: "created_at", order: "asc" });
  ...
  describe("getMeasurementsByDate", () => {
    ...
    it("should throw NOT_FOUND when aquarium does not exist", async () => {
      ...
      // Act & Assert
      await expect(service.getMeasurementsByDate(userId, aquariumId, date)).rejects.toThrow("NOT_FOUND");
    });
  });
});
