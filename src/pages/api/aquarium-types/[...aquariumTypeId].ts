...
export const GET: APIRoute = async ({ params, locals }) => {
  try {
    ...
    const paramValidation = aquariumTypeIdParamSchema.safeParse(params);
    ...
    const optimalValues = await referenceDataService.getOptimalValuesForAquariumType(
      paramValidation.data.aquariumTypeId
    );
    ...
    console.error("GET /api/aquarium-types/[...aquariumTypeId] error:", error);
